...
- Name: 09-navigation-search.spec.ts >> Sidebar — every link reachable for ADMIN >> TC-900.Payments ADMIN sidebar exposes Payments
...
Locator: getByRole('link', { name: /Payments/ }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /Payments/ }).first()
