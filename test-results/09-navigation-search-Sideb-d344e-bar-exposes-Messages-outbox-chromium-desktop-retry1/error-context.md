...
- Name: 09-navigation-search.spec.ts >> Sidebar — every link reachable for ADMIN >> TC-900.Messages outbox ADMIN sidebar exposes Messages outbox
...
Locator: getByRole('link', { name: /Messages outbox/ }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /Messages outbox/ }).first()
