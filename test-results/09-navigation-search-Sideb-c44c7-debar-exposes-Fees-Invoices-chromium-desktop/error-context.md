...
- Name: 09-navigation-search.spec.ts >> Sidebar — every link reachable for ADMIN >> TC-900.Fees & Invoices ADMIN sidebar exposes Fees & Invoices
...
Locator: getByRole('link', { name: /Fees & Invoices/ }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /Fees & Invoices/ }).first()
