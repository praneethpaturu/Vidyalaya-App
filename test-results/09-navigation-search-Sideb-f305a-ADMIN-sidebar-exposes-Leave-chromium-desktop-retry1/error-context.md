...
- Name: 09-navigation-search.spec.ts >> Sidebar — every link reachable for ADMIN >> TC-900.Leave ADMIN sidebar exposes Leave
...
Locator: getByRole('link', { name: /Leave/ }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /Leave/ }).first()
