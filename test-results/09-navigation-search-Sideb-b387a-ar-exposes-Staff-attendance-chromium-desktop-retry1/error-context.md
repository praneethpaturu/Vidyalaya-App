...
- Name: 09-navigation-search.spec.ts >> Sidebar — every link reachable for ADMIN >> TC-900.Staff attendance ADMIN sidebar exposes Staff attendance
...
Locator: getByRole('link', { name: /Staff attendance/ }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /Staff attendance/ }).first()
