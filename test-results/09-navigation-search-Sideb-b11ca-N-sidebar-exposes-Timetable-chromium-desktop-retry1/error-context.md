...
- Name: 09-navigation-search.spec.ts >> Sidebar — every link reachable for ADMIN >> TC-900.Timetable ADMIN sidebar exposes Timetable
...
Locator: getByRole('link', { name: /Timetable/ }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /Timetable/ }).first()
