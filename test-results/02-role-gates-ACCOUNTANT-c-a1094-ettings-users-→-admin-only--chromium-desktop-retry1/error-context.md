...
- Name: 02-role-gates.spec.ts >> ACCOUNTANT can reach finance + HR_FIN; cannot reach admin-only / HR people >> TC-056./Settings/users ACCOUNTANT /Settings/users → / (admin-only)
