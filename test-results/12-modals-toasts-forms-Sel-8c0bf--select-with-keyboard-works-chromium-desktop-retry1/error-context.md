...
- Name: 12-modals-toasts-forms.spec.ts >> Select / dropdown keyboard behavior >> TC-1331 changing role select with keyboard works
- Location: tests/qa-e2e/12-modals-toasts-forms.spec.ts:79:7
...
```
Error: locator.focus: Test timeout of 20000ms exceeded.
Call log:
