...
- Name: 08-content-safety.spec.ts >> XSS / output encoding >> TC-800 invite name with script tag is escaped on render
- Location: tests/qa-e2e/08-content-safety.spec.ts:6:7
