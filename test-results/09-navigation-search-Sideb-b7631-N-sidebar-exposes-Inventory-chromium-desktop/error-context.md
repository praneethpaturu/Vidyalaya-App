...
- Name: 09-navigation-search.spec.ts >> Sidebar — every link reachable for ADMIN >> TC-900.Inventory ADMIN sidebar exposes Inventory
...
Locator: getByRole('link', { name: /Inventory/ }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /Inventory/ }).first()
