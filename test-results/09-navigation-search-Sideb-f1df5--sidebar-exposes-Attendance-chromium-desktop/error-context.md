...
- Name: 09-navigation-search.spec.ts >> Sidebar — every link reachable for ADMIN >> TC-900.Attendance ADMIN sidebar exposes Attendance
...
Locator: getByRole('link', { name: /Attendance/ }).first()
Expected: visible
Timeout: 5000ms
