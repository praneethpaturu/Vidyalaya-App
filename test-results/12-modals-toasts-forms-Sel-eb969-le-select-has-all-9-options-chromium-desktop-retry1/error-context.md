...
- Name: 12-modals-toasts-forms.spec.ts >> Select / dropdown keyboard behavior >> TC-1330 invite role select has all 9 options
- Location: tests/qa-e2e/12-modals-toasts-forms.spec.ts:71:7
