...
- Name: 02-role-gates.spec.ts >> ACCOUNTANT can reach finance + HR_FIN; cannot reach admin-only / HR people >> TC-056./Home/email-settings ACCOUNTANT /Home/email-settings → / (admin-only)
