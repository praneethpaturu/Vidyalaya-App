...
- Name: 02-role-gates.spec.ts >> ACCOUNTANT can reach finance + HR_FIN; cannot reach admin-only / HR people >> TC-056b./Home/SIS ACCOUNTANT /Home/SIS → / (HR-only)
- Location: tests/qa-e2e/02-role-gates.spec.ts:74:9
