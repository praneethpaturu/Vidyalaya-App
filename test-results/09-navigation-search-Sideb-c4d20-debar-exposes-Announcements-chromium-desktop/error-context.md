...
- Name: 09-navigation-search.spec.ts >> Sidebar — every link reachable for ADMIN >> TC-900.Announcements ADMIN sidebar exposes Announcements
...
Locator: getByRole('link', { name: /Announcements/ }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /Announcements/ }).first()
